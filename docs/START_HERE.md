...
- [Loot Drop System](./LOOT_DROP_SYSTEM.md): how current rewards work, what the workbook drop rules say, and how the future source-governed drop engine should behave.
